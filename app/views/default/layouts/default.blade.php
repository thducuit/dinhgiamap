                  ...
                  <li class="menu_item ads-slider">
                    <div id="group-images-1" class="group-images">
                      <ul class="bxslider-1" role="listbox">
                        <li class="image-item"><div><img  src="{{ URL::asset('default/images/logo/Logo-03.jpg') }}"></img></div></li>
                        <li class="image-item"><div><img  src="{{ URL::asset('default/images/logo/STDA ngang.jpg') }}"></img></div></li>
                        <li class="image-item"><div><img  src="{{ URL::asset('default/images/logo/logo-nghe moi gioi.png') }}"></img></div></li>
                      </ul>
                    </div>
                  </li>
                  <li class="menu_item">
                  ...
                  <li class="menu_item ads-slider">
                    <div id="group-images-2" class="group-images">
                      <ul class="bxslider-2" role="listbox">
                        <li class="image-item"><div><img  src="{{ URL::asset('default/images/logo/logo techcombank.png') }}"></img></div></li>
                        <li class="image-item"><div><img  src="{{ URL::asset('default/images/logo/logo vietcombank.jpg') }}"></img></div></li>
                        <li class="image-item"><div><img  src="{{ URL::asset('default/images/logo/logo Agribank.jpg') }}"></img></div></li>
                      </ul>
                    </div>
                  </li>
                </ul>
